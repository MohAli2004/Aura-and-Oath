...
@section('title', __('storefront.page_title_orders'))
@section('content')
<div class="max-w-5xl mx-auto px-4 sm:px-6 py-10">
    <h1 class="font-display text-5xl mb-8">{{ __('storefront.orders') }}</h1>
    ...
    @empty
        <x-empty-state :title="__('storefront.no_orders_yet')" :action="route('shop')" :actionLabel="__('storefront.start_shopping')" />
    @endforelse
